...
uint32_t fstat64(uint32_t fd, uint32_t stat_addr, uint32_t reserved1, uint32_t reserved2, uint32_t reserved3) {
	...
	physical_to_virtual_memcpy(page_dir, (char*)dest_stat, (char*)stat_addr, sizeof(struct stat64));
