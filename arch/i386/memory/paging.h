...
// A variant of the above function that assumes the caller has passed in
// pointers to the correct page table entries.
...
// Sets the page flag in the CR0 register and then "refreshes" the MMU by
// copying CR3 and copying it back.
